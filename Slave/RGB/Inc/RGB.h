 ...
 *      Author: Hicham Sebaa
 *  This header file provides the necessary interface for effective communication with the TCS34725 sensor, facilitating the reading of RGB values and enabling further color processing applications.
 */
