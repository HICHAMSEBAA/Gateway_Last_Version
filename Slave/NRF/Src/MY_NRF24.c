...
void NRF24_Reset(rf24_datarate_e datarate, rf24_pa_dbm_e power) {

	NRF24_SoftwareReset();
	//Initialise retries 15 and delay 1250 usec
	NRF24_setRetries(15, 15);
	//Initialise data rate to 1Mbps
	NRF24_setDataRate(datarate);	//RF24_250KBPS RF24_1MBPS RF24_2MBPS
	//Initialise PA level to max (0dB)
	NRF24_setPALevel(power); //RF24_PA_m18dB  RF24_PA_m18dB RF24_PA_m12dB
